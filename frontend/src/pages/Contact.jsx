  ...
  return (
    <div className="max-w-[760px] mx-auto px-4 py-8 sm:py-12">
      ...
      <div className="flex items-center gap-3 mt-4">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-ink tracking-tight">Hubungi Kami</h1>
          <p className="text-sm text-gray-500">Respon maksimal 3 hari kerja</p>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-3 mt-6">
        {[
          ...
          <div key={c.t} className="rounded-2xl border border-gray-200/70 bg-white p-4 shadow-sm text-center">
            ...
            <div className="text-sm font-extrabold text-ink mt-2">{c.t}</div>
            <div className="text-xs text-gray-500 mt-0.5">{c.d}</div>
          </div>
        ))}
      </div>

      <div className="rounded-2xl border border-gray-200/70 bg-white p-5 sm:p-6 shadow-sm mt-4">
        {done ? (
          <div className="text-center py-6">
            ...
            <p className="font-extrabold text-ink mt-3">Pesan terkirim!</p>
            <p className="text-sm text-gray-500 mt-1">Tim kami akan membalas ke <span className="font-semibold text-gray-700">{form.email}</span> maksimal 3 hari kerja.</p>
          </div>
        ) : (
          <form onSubmit={submit} className="space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="text-[11px] font-bold text-gray-600 uppercase tracking-wide mb-1.5 block">Nama</label>
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-600 uppercase tracking-wide mb-1.5 block">Subjek</label>
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-600 uppercase tracking-wide mb-1.5 block">Pesan</label>
