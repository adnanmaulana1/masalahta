  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md fade-up">
        ...
        <div className="text-5xl font-extrabold text-ink mt-4">500</div>
        <h1 className="text-xl font-extrabold text-ink mt-1">Server sedang bermasalah</h1>
        <p className="text-sm text-gray-500 mt-2">Terjadi kesalahan di sisi kami. Coba muat ulang, atau kembali lagi beberapa saat.</p>
