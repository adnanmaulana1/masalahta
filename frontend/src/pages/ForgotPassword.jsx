    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="w-full max-w-md fade-up">
        <div className="bg-white rounded-2xl border border-gray-200/80 shadow-[0_20px_60px_-20px_rgba(11,95,208,0.25)] p-6">
          <Link to="/login" className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-500 hover:text-[#0e76f1] transition-colors">
            <Icon name="arrowRight" size={16} className="rotate-180" /> Kembali masuk
          </Link>
          <h1 className="text-xl font-extrabold text-ink tracking-tight mt-4">Lupa password?</h1>
          {!done ? (
            <>
              <p className="text-[13px] text-gray-500 mt-1">Masukkan email akunmu, kami kirimkan link reset password.</p>
            ...
            <div className="mt-5 text-center">
              ...
              <p className="text-sm font-bold text-gray-800 mt-3">Link reset terkirim</p>
              <p className="text-[13px] text-gray-500 mt-1">Jika <span className="font-semibold text-gray-700">{email}</span> terdaftar, cek inbox / spam untuk lanjut reset password.</p>
              {devToken && (
