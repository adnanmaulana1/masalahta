  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md fade-up">
        ...
        <h1 className="text-xl font-extrabold text-ink mt-2">Halaman tidak ditemukan</h1>
        <p className="text-sm text-gray-500 mt-2">Alamat yang kamu tuju salah atau sudah dipindahkan. Yuk kembali ke jalan yang benar.</p>
