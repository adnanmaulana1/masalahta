  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md fade-up">
        ...
        <div className="text-5xl font-extrabold text-ink mt-4 dark:text-gray-100">403</div>
        <h1 className="text-xl font-extrabold text-ink mt-1 dark:text-gray-100">Akses ditolak</h1>
        <p className="text-sm text-gray-500 mt-2 dark:text-gray-400">Kamu tidak punya izin membuka halaman ini.</p>
